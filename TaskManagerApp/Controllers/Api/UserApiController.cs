...
namespace TaskManagerApp.Controllers.Api
{
    ...
    public class UserApiController : ControllerBase
    {
        ...
        private readonly TaskManagerApp.Services.IFileStorageService _storageService;

        public UserApiController(AppDbContext context, TaskManagerApp.Services.IFileStorageService storageService)
        {
            _context = context;
